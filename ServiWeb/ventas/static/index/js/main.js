...
function editarPersonal(id, rut, nombre, apellido, telefono, email, empresa, direccion ) {
  ...
  document.getElementById("empresa_editar").value = empresa;
  document.getElementById("direccion_editar").value = direccion;
}

function editarProducto(id, codigo, nombre, descripcion, precio, cantidad) {
  document.getElementById("id_producto_editar").value = id;
  document.getElementById("codigo_editar").value = codigo;
  document.getElementById("nombre_editar").value = nombre;
  document.getElementById("descripcion_editar").value = descripcion;
